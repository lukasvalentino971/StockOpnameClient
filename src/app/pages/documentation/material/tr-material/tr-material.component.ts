...
@Component({
  selector: 'app-tr-material',
  templateUrl: './tr-material.component.html',
  styleUrls: ['./tr-material.component.css']
})
export class TrMaterialComponent implements OnInit{
  ...
  ngOnInit() {
    this.MasterService.getDocTransactionMaterial().subscribe((data: any) => {
      this.data = data;
