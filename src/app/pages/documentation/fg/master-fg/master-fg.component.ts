...
@Component({
  selector: 'app-master-fg',
  templateUrl: './master-fg.component.html',
  styleUrls: ['./master-fg.component.css']
})
export class MasterFgComponent implements OnInit {
  ...
  ngOnInit() {
    this.MasterService.getDocMasterFg().subscribe((data: any) => {
      this.data = data;
