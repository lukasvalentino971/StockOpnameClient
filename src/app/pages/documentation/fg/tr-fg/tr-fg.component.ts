...
@Component({
  selector: 'app-tr-fg',
  templateUrl: './tr-fg.component.html',
  styleUrls: ['./tr-fg.component.css']
})
export class TrFgComponent implements OnInit {
  ...
  ngOnInit() {
    this.MasterService.getDocTransactionFg().subscribe((data: any) => {
      this.data = data;
