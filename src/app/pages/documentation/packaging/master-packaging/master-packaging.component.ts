...
@Component({
  selector: 'app-master-packaging',
  templateUrl: './master-packaging.component.html',
  styleUrls: ['./master-packaging.component.css']
})
export class MasterPackagingComponent implements OnInit{
  ...
  ngOnInit() {
    this.MasterService.getDocMasterPackaging().subscribe((data: any) => {
      this.data = data;
