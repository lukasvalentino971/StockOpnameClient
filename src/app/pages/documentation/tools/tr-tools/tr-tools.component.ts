...
@Component({
  selector: 'app-tr-tools',
  templateUrl: './tr-tools.component.html',
  styleUrls: ['./tr-tools.component.css']
})
export class TrToolsComponent implements OnInit{
  ...
  ngOnInit() {
    this.MasterService.getDocTransactionTools().subscribe((data: any) => {
      this.data = data;
